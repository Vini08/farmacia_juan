...
CREATE TABLE `inyecciones` (
  `id_inyecciones` int(11) NOT NULL AUTO_INCREMENT,
  `categoria` varchar(25) DEFAULT NULL,
  `producto` varchar(45) DEFAULT NULL,
  `hora` varchar(45) DEFAULT NULL,
  `fecha` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_inyecciones`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `inyecciones`
--

LOCK TABLES `inyecciones` WRITE;
/*!40000 ALTER TABLE `inyecciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `inyecciones` ENABLE KEYS */;
UNLOCK TABLES;
