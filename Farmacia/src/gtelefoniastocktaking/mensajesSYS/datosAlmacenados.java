 ...
 * @author Vinicio
 */
public class datosAlmacenados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Los datos fueron almacenados correctamente.");
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(datosAlmacenados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new datosAlmacenados().setVisible(true);
            }
        });
    }
